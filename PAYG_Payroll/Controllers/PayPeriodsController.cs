...
namespace PAYG_Payroll.Controllers
{
    public class PayPeriodsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "pp_id,pp_name,pp_weeks")] PayPeriod payPeriod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "pp_id,pp_name,pp_weeks")] PayPeriod payPeriod)
        {
            if (ModelState.IsValid)
            {
